...
import com.caito.gestionrestaurante.dto.ErrorDTO;
...
public class RestHandlerException {
    ...
    @ExceptionHandler(NotAuthorizeExcepcion.class)
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    protected ResponseEntity<ErrorDTO> notAuthorizeException(Exception e, HttpServletRequest request){
